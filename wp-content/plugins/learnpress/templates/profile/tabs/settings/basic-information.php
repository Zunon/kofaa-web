...
<form method="post" id="learn-press-profile-basic-information" name="profile-basic-information"
    ...
    <ul class="form-fields">
        ...
        <li class="form-field">
            <label for="description"><?php if(get_bloginfo("language") == "ar") { _e( 'معلومات السيرة الذاتية	', 'learnpress' ); }else { _e( 'Biographical Info	', 'learnpress' ); }  ?></label>
            <div class="form-field-input">
                <textarea name="description" id="description" rows="5"
                          cols="30"><?php esc_html_e( $user->get_data( 'description' ) ); ?></textarea>
                <p class="description"><?php 
				if(get_bloginfo("language") == "ar") { _e( 'معلومات السيرة الذاتية	', 'learnpress' ); }else { _e( 'شارك القليل من معلومات السيرة الذاتية لملء ملفك الشخصي. قد تظهر ذلك علنا.', 'learnpress' );}
    ...
    <button type="submit" name="submit"><?php if(get_bloginfo("language") == "ar") { 
