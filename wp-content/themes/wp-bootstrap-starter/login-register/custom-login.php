...
if(isset($_POST['forgotlogin'])) {
    ...
    if($email!="" && $email!= NULL ) {
        ...
        <br><br>
        ".$site_url."/wp-content/themes/wp-bootstrap-starter/login-register/custom-login.php?action=rp&key=".$key."&login=".$email->user_email."&lang=".$lang."
        <br><br>
...
if($_REQUEST['action'] == 'rp') {
    ...
    <section id="page">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 auto-mar" style="margin: 0 auto;">
