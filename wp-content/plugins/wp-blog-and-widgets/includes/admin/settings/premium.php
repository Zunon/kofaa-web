	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>WP Blog and Widget</strong> included in <br /><strong>Essential Plugin Bundle</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>WP Blog and Widget</strong> included in <br /><strong>Essential Plugin Bundle</p>
				<a href="https://www.wponlinesupport.com/pricing/?ref=WposPratik&utm_source=WP&utm_medium=Blogcpt&utm_campaign=Upgrade-PRO" target="_blank">View Buying Options</a></td>
	    	</tr>
	    </tfoot>
	    ...
	    <tbody>
	    	...
	    	<tr>
	    		<th>Visual Composer/WPBakery Page Builder Supports <span>Use this plugin with Visual Composer/WPBakery Page Builder easily</span></th>
	    		<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
			<tr>
