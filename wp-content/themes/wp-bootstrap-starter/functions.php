...
add_rewrite_rule( 
    ...
    'index.php?pagename=course-detail&course_id=$matches[1]', 
    'top'
 ); 
 add_filter('query_vars', function( $vars ){
	...
	// Add home page slider custom post type
	function home_banner_custom_post_type() {
		$labels = array(
			'name'                => __( 'Home_banner' ),
			'singular_name'       => __( 'Home_banner'),
			'menu_name'           => __( 'Home Banner'),
			'parent_item_colon'   => __( 'Parent slide'),
			'all_items'           => __( 'All Slides'),
			'view_item'           => __( 'View slide'),
			'add_new_item'        => __( 'Add Slide Image'),
		...
		$args = array(
			...
			'description'         => __( 'Best Crunchify Home_banner'),
			'labels'              => $labels,
	...
	add_action( 'init', 'home_banner_custom_post_type', 0 );

	// add custom popup
	function custom_popup_posttype() {
	// Set UI labels for Custom Post Type
		$labels = array(
			'name'                => _x( 'Popups', 'Post Type General Name', 'modernizer' ),
			'singular_name'       => _x( 'Popup', 'Post Type Singular Name', 'modernizer' ),
			'menu_name'           => __( 'Login Registration Popup', 'modernizer' ),
			'parent_item_colon'   => __( 'Parent Movie', 'modernizer' ),
			'all_items'           => __( 'All Popup', 'modernizer' ),
			'view_item'           => __( 'View Popup', 'modernizer' ),
			'add_new_item'        => __( 'Add New Popup', 'modernizer' ),
			'add_new'             => __( 'Add Popup', 'modernizer' ),
			'edit_item'           => __( 'Edit Popup', 'modernizer' ),
			'update_item'         => __( 'Update Popup', 'modernizer' ),
			'search_items'        => __( 'Search Popup', 'modernizer' ),
	...
	// Set other options for Custom Post Type
		...
		$args = array(
			'label'               => __( 'popups', 'modernizer' ),
			'description'         => __( 'popup Templates and Snippets', 'modernizer' ),
			'labels'              => $labels,
	...
	add_action( 'init', 'custom_popup_posttype', 0 );
