...
<p><?php _e('Need Marketing Insight? ,','woocommerce-salesforce-crm')?> <a href="<?php echo $plugin_url ?>&section=vxc_premium"><?php _e('Go Pro!','woocommerce-salesforce-crm')?></a></p>
</div>
 <?php
 return;
 }
...
if(!$html_added){
   ?> 
   <h3 style="text-align: center;"><?php _e('No Information Available','woocommerce-salesforce-crm')?></h3>
   <?php
return;
}
