		...
		public function toggle_course_wishlist() {
			...
			if ( sizeof( $wishlist ) ) {
			 ...
			 if(get_bloginfo("language") == "ar") {
				$wishlist = "إزالة من قائمة الرغبات"; 
				$removewishlist = "أضف إلى قائمة الامنيات"; 
				}else { 
			...
			learn_press_send_json(
				array(
					...
					'message'     => '',
					'button_text' => $state != 'on' ? __( $wishlist, 'learnpress-wishlist' ) : __( $removewishlist, 'learnpress-wishlist' )
				)
			);
		}
