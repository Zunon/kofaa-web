...
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields = array(
		'author' => sprintf(
			'<p class="comment-form-author widht50 font18px font-weight5">%s %s</p>',
			sprintf(
			...
			sprintf(
				'<input id="author" name="author" class="form-control" type="text" value="%s" size="30" maxlength="245"%s />',
				esc_attr( $commenter['comment_author'] ),
				$html_req
			)
		),
		'email'  => sprintf(
			'<p class="comment-form-email widht50 font18px font-weight5">%s %s</p>',
			sprintf(
			...
			sprintf(
				'<input id="email" name="email" %s value="%s" class="form-control" size="30" maxlength="100" aria-describedby="email-notes"%s />',
		...
		'url'    => sprintf(
			'<p class="comment-form-url widht50 font18px font-weight5">%s %s</p>',
			sprintf(
				'<label for="url">%s</label>',
				__( 'Website' )
			),
			sprintf(
				'<input id="url" name="url" %s value="%s" class="form-control" size="30" maxlength="200" />',
