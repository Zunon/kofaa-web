...
?>
<div class="col-md-10 auto-mar">
	<table class="table order_table font20px">
		<tbody>
			<tr>
			<th scope="row"><?php esc_html_e( 'Order number:', 'woocommerce' ); ?></th>
			<td><strong><?php echo esc_html( $order->get_order_number() ); ?></strong></td>
			</tr>
			<tr>
			<th scope="row"><?php esc_html_e( 'Date:', 'woocommerce' ); ?></th>
