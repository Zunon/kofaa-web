...
?>
<h3 class="profile-heading">Wishlist</h3>
    <div id="learn-press-profile-tab-course-wishlist" class="<?php echo $has_courses ? 'has-courses' : ''; ?>">
		...
		if(get_bloginfo("language") == "ar") { 
				learn_press_display_message( apply_filters( 'learn_press_wishlist_empty_course', __( 'لا توجد دورات في قائمة رغباتك!', 'learnpress-wishlist' ) ) );
			}else {
				learn_press_display_message( apply_filters( 'learn_press_wishlist_empty_course', __( 'No courses in your wishlist!', 'learnpress-wishlist' ) ) );
			}
		 ?>
    </div>
<?php
