...
<div id="comments" class="comments-area">
    ...
    <?php comment_form( $args = array(
        ...
        'title_reply'       => __( 'اترك رد', 'wp-bootstrap-starter' ),  // that's the wordpress default value! delete it or edit it ;)
		/* translators: 1: Reply Specific User */
        'title_reply_to'    => __( 'اترك ردا ل %s', 'wp-bootstrap-starter' ),  // that's the wordpress default value! delete it or edit it ;)
        'cancel_reply_link' => __( 'إلغاء التعليق', 'wp-bootstrap-starter' ),  // that's the wordpress default value! delete it or edit it ;)
        'label_submit'      => __( 'أضف تعليقا', 'wp-bootstrap-starter' ),  // that's the wordpress default value! delete it or edit it ;)

        'comment_field' =>  '<p><textarea placeholder="ابدأ الطباعة..." id="comment" class="form-control" name="comment" cols="45" rows="8" required></textarea></p>',

        'comment_notes_after' => '<p class="form-allowed-tags font18px font-weight5">' .
